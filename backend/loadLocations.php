...
foreach($locations as $location) {
    ...
    <tr class=\"targetTr\">
        ...
        <td class=\"icon rightest\">
            <button onclick=\"editButtonClicked(this)\" class=\"button editButton\">
                <image src=\"../content/edit_icon_16.png\" width=\"16px\" height=\"16px\"></image>
            </button>
        </td>
        <td class=\"icon rightest\">
            <button class=\"button deleteButton\">
                <image src=\"../content/delete_icon_16.png\" width=\"16px\" height=\"16px\"></image>
            </button>
        </td>
    </tr>
    ";
